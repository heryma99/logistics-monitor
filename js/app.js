...
var App = (function(){
  ...
  function transit(){
    ...
    var histCard = '<div class="card"><h3>历史段偏差（已签收货件：ATD→ATA 实际 vs 参考物流+查验）</h3><table><tr><th>线路（国家·渠道）</th><th>票数</th><th>实际均(天)</th><th>参考均(天)</th><th>偏差</th><th>超参考占比</th></tr>'+hist+"</table><p class=\"muted\" style=\"margin-top:6px\">口径注：实际=ATD→ATA(到港/到仓)；参考=物流+查验至派送，故空运类实际常小于参考属正常，正偏差(+天)才是真延误。</p></div>";
